function checkStrength(){
	...
	var value = document.getElementById("checkpsw1");
...
function checkPassword(){
	...
	var value = document.getElementById("checkpsw2");
	if(psw1 != psw2)
	{
		value.innerHTML = "两次输入的密码必须一致!";
	}
	else{
		value.innerHTML = " ";
	}
...
//        document.getElementById("gender").checkValidity() &&
...
// 	 // provinceOption.value = provinceOption.text = "北京市"；
// 	 // province.options.add(provinceOption);
// 	// var provinceArr[];
	 
//      province.options.add(new Option("北京","北京"));
